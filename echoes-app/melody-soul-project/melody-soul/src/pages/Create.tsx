                      ...
                      {message.music.url ? (() => {
                        ...
                        return (
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {/* 分享给好友 */}
                            <button
                              onClick={() => setShareMusic({ id: m.id, title: m.title, cover: m.cover, duration: m.duration, url: m.url, mood: m.mood })}
                              aria-label="分享给好友"
                              className="w-11 h-11 rounded-full bg-ink-50 text-ink-500 hover:text-echo-green flex items-center justify-center btn-press"
                            >
